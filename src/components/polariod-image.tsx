  ...
  return (
    <div className="w-full flex justify-center items-center py-8 sm:py-12 lg:py-16 relative overflow-hidden">
      <div className="relative w-full max-w-md mx-auto px-4">
        ...
        <div className="absolute top-4 left-1/2 md:left-1/4 transform -translate-x-1/2 bg-white shadow-xl rounded-lg p-3 rotate-[6deg] hover:z-50 transition-all duration-300 hover:scale-105 hover:rotate-[3deg] w-[250px] md:w-full max-w-xs z-10">
          <Image
