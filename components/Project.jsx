  ...
  return (
    <div className="group flex relative">
        <Image
            ...
            width={100}
            height={100}
            className="rounded-lg border border-solid border-gray-950 shadow-lg object-cover w-[300px] h-[200px] xl:w-[400px] xl:h-[200px] filter group-hover:accent transition duration-300 ease-in-out"
        />
