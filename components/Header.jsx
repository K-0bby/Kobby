...
const PDF_FILE_URL = 'https://drive.google.com/file/d/10cTqJB6yw3MQw8bv4etrVaKn5Yf0P09A/view?usp=drive_link';
const Header = () => {
    const downloadFileAtURL= (url) =>  {
    const link = document.createElement('a');
    link.href = url;
    link.setAttribute('download', 'https://drive.google.com/file/d/10cTqJB6yw3MQw8bv4etrVaKn5Yf0P09A/view?usp=drive_link');
